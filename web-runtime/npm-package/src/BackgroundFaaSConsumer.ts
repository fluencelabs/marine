...
export class BackgroundFaaSConsumer implements BackgroundFaaS {
    private _worker?: ModuleThread<BackgroundFaaS>;
    ...
    async init(marineWasm: SharedArrayBuffer): Promise<void> {
        ...
        this._worker = await spawn<BackgroundFaaS>(new Worker(this._workerPath));
