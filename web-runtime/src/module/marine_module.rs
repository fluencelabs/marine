...
//use crate::marine_js::ImportObject;
...
impl MModule {
    pub(crate) fn new(
       ...
       // let wasmer_instance = wasmer_module.instantiate(&wasi_import_object)?;
        ...
        /*
        #[rustfmt::skip]
        if let Ok(start_func) = wasmer_instance.exports.get::<crate::marine_js::Func<'_, (), ()>>("_start") {
            start_func.call()?;
        }*/
...
*/
    ...
    fn adjust_wit_imports(
        ...
        use crate::marine_js::DynamicFunc;
