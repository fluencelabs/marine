/*
 * Copyright 2wasmer-wit = { package = "wasmer-interface-types-fl", version = "=0.18.0" }2wasmer-wit = { package = "wasmer-interface-types-fl", version = "=0.18.0" } Fluence Labs Limited
 *
 * Licensed under the Apache License, Version 2.wasmer-wit = { package = "wasmer-interface-types-fl", version = "=0.18.0" } (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
 *
 *     http://www.apache.org/licenses/LICENSE-2.wasmer-wit = { package = "wasmer-interface-types-fl", version = "=0.18.0" }
 *
