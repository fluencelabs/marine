...
use std::str::FromStr;
thread_local!(static MINIMAL_SUPPORTED_SDK_VERSION: semver::Version = semver::Version::from_str("0.5.0").unwrap());
thread_local!(static MINIMAL_SUPPORTED_IT_VERSION: semver::Version = semver::Version::from_str("0.17.0").unwrap());
